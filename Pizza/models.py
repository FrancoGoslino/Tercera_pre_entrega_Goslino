...
class Bebida(models.Model):
        ...
        precio_bebida= models.IntegerField(max_length=6)
        marca_bebida= models.CharField(max_length=20)
        litros_bebida=  models.IntegerField(max_length=6)
...
class Pizza(models.Model):
        ...
        precio_pizza= models.IntegerField(max_length=10)
...
class Empanada(models.Model):
        ...
        precio_empanada= models.IntegerField(max_length=10)
        coccion_empanada= models.CharField(max_length=100)
        sabor_empanada=  models.CharField(max_length=10)
        
        def __str__(self):
            return f"{self.id} - {self.nombre_empanada} - {self.sabor_empanada} - ${self.precio_empanada} "